...
public class CampanionLootTablesGenerator extends LootTableProvider {
	...
	public CampanionLootTablesGenerator(PackOutput packOutput, CompletableFuture<HolderLookup.Provider> provider) {
		super(packOutput, Set.of(), List.of(new LootTableProvider.SubProviderEntry(CampanionBlockLoot::new, LootContextParamSets.BLOCK)), provider);
	}

	public static class CampanionBlockLoot extends BlockLootSubProvider {
		protected CampanionBlockLoot(HolderLookup.Provider pRegistries) {
		...
		protected void generate() {
			...
			this.add(CampanionBlocks.FLARE_BLOCK, noDrop());
		}
