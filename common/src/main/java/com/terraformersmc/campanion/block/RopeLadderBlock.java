...
public class RopeLadderBlock extends LadderBlock {
	...
	@Override
	protected ItemInteractionResult useItemOn(ItemStack stackInHand, BlockState pState, Level world, BlockPos pos, Player player, InteractionHand hand, BlockHitResult pHitResult) {
		...
		return super.useItemOn(stackInHand, pState, world, pos, player, hand, pHitResult);
	}
